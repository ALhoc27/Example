...
import main.Algorithm.configAlgorithm.EstimationAlgorithmComplexity;
...
public class Palindrome {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" В этом алгоритме цикл выполняется n/2 раз, где n — длина строки. Казалось бы, сложность работы алгоритма должна быть равна O(n/2)\nНо, как и в прошлый раз, это не так. Алгоритмы со временем работы 2n, 10n, n/5, n/32 — все имеют сложность O(n).");
        System.out.println("");
        palindrome("ab");
        System.out.println();
        palindrome("aha");
